		...
		\begin{frame}{Informationsquellen}
			\begin{columns}[T]
				...
				\begin{column}{0.39\textwidth}
					\only<1>{\includegraphics[width=1.1\linewidth]{images/info-source-routing-1.png}}
					\only<2->{\includegraphics[width=1.1\linewidth]{images/info-source-routing-2.png}}
				\end{column}
			\end{columns}
		\end{frame}
		...
		\subsection{Mehrtägige Touren}
			...
			\begin{frame}{Planung}
				...
				\begin{itemize}
					\item An- \& Abreise
					\item Etappen
					\item Unterkünfte (Orte zum Wild campen, Campingplätze, Hütten, etc.)
					\item Genug Essen
			...
			\begin{frame}{Equipment}
				...
				Je nach Situation einpacken:
				\begin{itemize}
					\item Kocher, Utensilien zum Feuer machen
				\end{itemize}
			\end{frame}
		...
		\subsection{Sicherheit}
			...
			\begin{frame}{}
				\begin{itemize}
					...
					\begin{itemize}
						\item An Wetter, Temperatur und allg. Gegebenheiten angepasst
						\item Erste-Hilfe-Set
