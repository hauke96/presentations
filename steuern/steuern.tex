		...
		\subsection{Exkurs: Kapitalerträge}
			...
			\begin{frame}
				\begin{itemize}
					...
					\item Kapitalerträge $\neq$ Einkommen \textrightarrow\ Kapitalertragssteuer
		...
		\subsection{Nochmal in Kürze}
			...
			\begin{frame}
				\begin{itemize}
					...
					\item Steuererklärung ohne großen Aufwand online machen
					...
					{\tiny (Spenden/Mitgliedsbeiträge sind immer Sonderausgaben)}
				\end{itemize}
			\end{frame}
