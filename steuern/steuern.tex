...
%		\setbeamertemplate{background}{\includegraphics[width=\paperwidth,trim=0 0 0 3.5cm]{images/tax-government}}
		...
		\subsection{Wie viel Steuern muss ich zahlen?}
			...
			\begin{frame}{Steuersätze}
				\begin{itemize}
					...
					\end{itemize}
				\end{itemize}
				Ja aber wie viel ist das jetzt?\pause\ Hä, na so viel, ist doch klar\citewiki[Einkommenssteuer]{Einkommensteuer_(Deutschland)\#Tarif_2020}:
				\begin{center}
					\only<0-4>{
	...
	\section{Steuererklärung}
		...
		\begin{frame}{Disclaimer}
			Im Folgenden \textbf{Fokus auf nicht-selbstständige Arbeit} (= Angestellte \& Werkstudenten) \textrightarrow\ Einkommenssteuer\n\pause\footnotesize
