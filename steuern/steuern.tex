		...
		\subsection{Wie viel Steuern muss ich zahlen?}
			...
			\begin{frame}{Steuersätze}
				\begin{itemize}
					...
					\end{itemize}
				\end{itemize}
				Ja aber wie viel ist das jetzt?!\pause\ Na so viel, ist doch klar\citewiki[Einkommenssteuer]{Einkommensteuer_(Deutschland)\#Tarif_2020}:
				\begin{center}
					\only<0-4>{
		...
		\subsection{Aller Anfang ist schwer}
			...
			\begin{frame}{Lohnsteuerbescheinigung}
				\begin{center}
					...
					\citeurl{https://www.smartsteuer.de/online/wp-content/uploads/2021/11/Elektronische-Lohnsteuerbescheinigung-2021.png}{smartsteuer.de}
				\end{center}
			\end{frame}
		...
		\subsection{Das kannst du absetzen}
			...
			\begin{frame}{Wege zur Arbeit/Uni}
				...
				\begin{itemize}
					...
					\begin{itemize}
						\item Bei Auswärtstätigkeit (s. Verpflegungsmehraufwand): hin + zurück
					\end{itemize}
			...
			\begin{frame}{Semesterbeitrag (inkl. Semesterticket)}
				...
				\hfill\\\pause
				\textbf{Hinweis 1:} Entfernungspauschale für Auto, Rad, Fuß geht trotzdem. Steuern sparen durch Rad fahren :D\n\pause
				\textbf{Hinweis 2:} Kilometerpauschale für Strecken mit ÖPNV nutzen, wenn Summe der Pauschalen $>$ Semesterticket \textrightarrow\ Semesterbeitrag um Ticketpreis kürzen!
			\end{frame}
