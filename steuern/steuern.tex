	...
	\section{Einkommen und Steuern}
		...
		\subsection{Muss ich steuern zahlen?}
			...
			\begin{frame}{Von der Steuer absetzen}
				...
				\textbf{Lösung:} Dem Finanzamt nachträglich über Ausgaben informieren und zu viel gezahlte Steuern zurück bekommen\footnote{PORSCHE CAYMAN S JUNGS! JAWOLL, JAAA! GEIL MAN!}\ \textrightarrow\ \textbf{Steuererklärung} :)
			\end{frame}
