...
%		\setbeamertemplate{background}{\includegraphics[width=\paperwidth,trim=0 0 0 3.5cm]{images/tax-government}}
	...
	\section{Basics}
		...
		\begin{frame}{Warum eigentlich Steuern?}
			\begin{itemize}
				\item Deckung Staatshaushalt\ \textrightarrow\  \href{https://www.bundeshaushalt.de/DE/Bundeshaushalt-digital/bundeshaushalt-digital.html}{bundeshaushalt.de}
				\begin{itemize}
					\item Straßen, Eisenbahn, ÖPNV, Zuschüsse zur Rente, Bildung, BAföG, Wettervorhersage, sämtliche Ämter/Verwaltungen
				\end{itemize}
				\item Lenkung von Verhalten (z.B. Tabacksteuer\ \textrightarrow\ Leute sollen weniger rauchen)
				\item Umverteilung (idealerweise von reich zu arm)
			\end{itemize}
		\end{frame}
	
		\begin{frame}{Von wem an wen werden Steuern gezahlt?}
			Steuersubjekt (TODO: ref) zahlt Steuern an Bund/Land/Gemeinde:\n
