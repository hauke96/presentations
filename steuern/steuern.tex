	...
	\section{Einkommen \& Steuern}
		...
		\subsection{Wie viel Steuern muss ich zahlen?}
			...
			\begin{frame}{Steuersätze}
				\begin{itemize}
					\item Wie viel Steuern muss ich denn jetzt zahlen?\pause\ ... well\pause
					\begin{itemize}
						\item Steuersatz pro Euro berechnet
						\item Steuersatz nach Zonen (je nach zu versteuerndem Einkommen)
						\pause
						\item Grenzsteuersatz: Steuersatz auf den höchsten Euro Einkommen
						\item Durchschnittssteuersatz: Steuersatz bezogen auf alle verdienten Euros
					\end{itemize}\pause
...
%				8h in Bibliothek der UHH die außerhalb des Campus-Teils (z.B. Ikum) ist, in dem man normalerweise studiert und die somit räumlich vom Rest der ersten Tätigkeitsstätte getrennt ist \textrightarrow\ ... keine Ahnung, aber ein Versuch ists wert
			...
			\begin{frame}{Nebenkosten}
				Sog. haushaltsnahe Dienstleistungen\citeurl{https://www.buhl.de/steuer/ratgeber/nebenkosten-abrechnung-absetzen}{buhl.de} werden von Steuer \textbf{abgezogen}, z.B.:
				\begin{itemize}
