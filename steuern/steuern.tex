	...
	\section{Steuererklärung}
		...
		\subsection{Das kannst du absetzen}
			...
			\begin{frame}{Semesterbeitrag (inkl. Semesterticket)}
				...
				\textbf{Hinweis 2:} Summe Pauschalen für Strecken mit ÖPNV $>$ Semesterticket? \textrightarrow\ Die Kilometerpauschale angeben \textrightarrow\ Semesterbeitrag um Preis für Semesterticket kürzen
			\end{frame}
