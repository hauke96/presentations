...
\begin{document}
	...
	\begin{frame}[plain]
		\begin{tikzpicture}
			\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=\textwidth]{images/bahn-brief}};
	...
	\begin{frame}[plain]
		\begin{tikzpicture}
   			...
   			\only<3-6>{
   				...
   				\node[inner sep=0.2mm,fill=black] at (6.5,5.275) {\includegraphics[width=3cm]{images/kontaktformular-bestaetigung}};
   			}
	   		\only<3-4>{
   			...
   			\only<4-6>{
   				...
   				\node[inner sep=0.2mm,fill=black] at (6.5,2.6) {\includegraphics[width=3cm]{images/antwort-mail}};
   			}
	  		\only<4>{
	...
	\begin{frame}[plain]
		\begin{tikzpicture}
			\node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=\textwidth]{images/verzoegerung-briefe}};
