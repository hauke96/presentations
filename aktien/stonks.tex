	...
	\section{Basics}
		...
		\subsection{Spekulieren}
			...
			\begin{frame}
				...
				\textbf{Beispiele:}
				\begin{itemize}
					\item Kauf einer Aktie, Verkauf am Folgetag.
					\item Bunkern von Getreide: Hoffnung auf Kriege und Wirtschaftskrisen.
				\end{itemize}
			\end{frame}
		...
		\subsection{Zins und Zinseszins}
			...
			\begin{frame}{Zinsen: Der Zinseszins-Effekt}
				...
				\begin{itemize}
					...
					\item 2023: 121,00€ \textrightarrow\ 12,10€ Zinsen \textrightarrow\ 133,10€
				\end{itemize}
			\end{frame}
